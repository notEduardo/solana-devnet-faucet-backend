...
- **Description**: Adds a new rate limit combination entry. Each combination of `ip_address`, `wallet_address`, and `github_username` is checked for uniqueness before inserting to DB.
- **Request Body**:
  ```json
  {
    "ip_address": "string",
